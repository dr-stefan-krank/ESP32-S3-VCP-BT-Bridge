...
#define NETGEAR_VID (0x846)          // Netgear
#define CP210X_PID (0xEA60)          // Single i.e. CP2101 - CP2104
#define CP210X_NETGEAR_PID (0x1100)  // Netgear
...
class CP210x : public CdcAcmDevice {
   public:
     ...
     *
     * @param[in] vid            VID (e.g. SILICON_LABS_VID or NETGEAR_VID)
     ...
     */
    CP210x(uint16_t vid, uint16_t pid,
    ...
    static constexpr std::array<uint16_t, 2> vids = {SILICON_LABS_VID,
                                                     NETGEAR_VID};
    static constexpr std::array<uint16_t, 4> pids = {
        CP210X_PID, CP2105_PID, CP2108_PID, CP210X_NETGEAR_PID};
